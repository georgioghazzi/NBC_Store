...
class ControllerExtensionModuleNewsletters extends Controller {
	...
	public function index() {
		...
		$this->load->model('caprica/newsletter');
		$this->model_caprica_newsletter->createNewsletter();
		...
		$this->load->model('caprica/newsletter');
		$result=$this->model_caprica_newsletter->getNewsLetter();
		$data['newsltr'] = array();
	...
	public function uninstall() {
		...
		$this->model_caprica_newsletter->dropNewsletter();
	}
